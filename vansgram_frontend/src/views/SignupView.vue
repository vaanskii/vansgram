    ...
    <div class="max-w-7xl mx-auto grid grid-cols-2 gap-4">
        ...
        <div class="main-left ">
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                ...
                <p class="font-bold">Already have an account? <RouterLink :to= "{'name':'login'}" class="underline">Click here</RouterLink> to log in!
                </p>
            </div>
        </div>
                ...
                axios
                    ...
                    .then(response => {
                        if (response.data.message === 'success') {
                            this.toastStore.showToast(5000, 'The user is registered. Please verify your account ', 'bg-emerald-500')
