    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="main-center col-span-2 space-y-4">
            <div
                ...
                >
                <h2 class="mb-6 text-xl text-center">Friend requests</h2>
                <div 
                ...
                >
                    ...
                    <div class="mt-6 space-x-4">
                        ...
                        <button class="inline-block py-4 px-6 bg-red-600 text-white rounded-lg" @click="handleRequest('declined', friendshipRequest.created_by.id)">Decline</button>
                    </div>
