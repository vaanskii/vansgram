<template>
    <div class="mb-6 flex items-center justify-between">
                ...
                <div class="my-6 flex justify-between">
                    <div class="flex space-x-6 items-center">
                        ...
                        <svg @click="likePost(post.id)"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <div v-if="post.is_private" class="text-gray-500 text-xs flex items-center space-x-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <div @click="toggleDots" class="cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <div v-if="showDots">
        <div class="flex space-x-6 items-center">
            <div v-if="userStore.user.id == post.created_by.id" class="text-gray-500 text-xs flex items-center space-x-2 cursor-pointer" @click="deletePost">
